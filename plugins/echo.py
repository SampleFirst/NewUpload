            ...
            if "formats" in response_json:
                for formats in response_json["formats"]:
                    ...
                    if "filesize" in formats:
                        ...
                        if format_string is not None and not "audio only" in format_string:
                            ...
                            ikeyboard = [
                                InlineKeyboardButton(f"📦 [{format_string}] ( {approx_file_size} )", callback_data=cb_string_file)
                            ]
                ...
                if duration is not None:
                    ...
                    inline_keyboard.append(
                        [
                            InlineKeyboardButton(f"🎵 MP3 (64 kbps)", callback_data=cb_string_64),
                            InlineKeyboardButton(f"🎵 MP3 (128 kbps)", callback_data=cb_string_128)
                        ]
                    )
                    inline_keyboard.append(
                        [
                            InlineKeyboardButton(f"🎵 MP3 (320 kbps)", callback_data=cb_string)
                        ]
                    )
                    inline_keyboard.append(
                        [
                ...
                inline_keyboard.append(
                    [
                        InlineKeyboardButton("🎬 MEDIA", callback_data=cb_string_video)
                    ]
                )
                cb_string_file = f"file={format_id}={format_ext}"
                cb_string_video = f"video={format_id}={format_ext}"
